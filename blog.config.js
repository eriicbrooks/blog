const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'fukasawa', // å½åä¸»é¢ï¼å¨themesæä»¶å¤¹ä¸å¯æ¾å°æææ¯æçä¸»é¢ï¼ä¸»é¢åç§°å°±æ¯æä»¶å¤¹åï¼ä¾å¦ example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
