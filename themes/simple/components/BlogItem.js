...
export const BlogItem = props => {
  ...
  return <div key={post.id} className="h-42 my-6 pb-12 border-b dark:border-gray-800" >
        ...
        <div className='block'>
            <Link href={`${siteConfig('SUB_PATH', '')}/${post.slug}`} className='inline-block rounded-sm text-yellow-600 text-s dark:border-gray-600 border hover:text-yellow-400 transition-all duration-100 hover:border-yellow-300 h-9 leading-8 px-5'>
