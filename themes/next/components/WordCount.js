...
export default function WordCount() {
  ...
  return <div id='wordCountWrapper' className='flex justify-center my-auto font-light'>
    <i className='mr-1 fas fa-file-word my-auto' /> <span className='hidden md:block'>Word count</span> <strong id='wordCount'>0</strong> &nbsp;|&nbsp; <i className='mr-1 fas fa-clock my-auto' /> <span className='hidden md:block'>Reading time ≈</span> <strong id='readTime'>0</strong> min
  </div>
}
